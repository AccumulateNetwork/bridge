...
/*
func (g *Gnosis) GenerateGnosisSafeTx(bridgeAddress string, txData string, signatures string) ([]byte, error) {
	...
	data, err := abiutil.GenerateGnosisTx(bridgeAddress, txData, signatures)
	if err != nil {
		return nil, err
	}
